    ...
    <Box p={5} style={{"backgroundColor":"#FFD1DC"}}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={3}>
          <Paper elevation={3}>
            <Box p={2}>
              <Typography>For booking and inquiries:</Typography>
              <Typography>Ken Treusch</Typography>
              <Typography>Bleecker Street Entertainment</Typography>
              <Typography>212-595-1974</Typography>
            </Box>
          </Paper>
        </Grid>
      </Grid>
      ...
      <Grid container spacing={3} alignItems="center" justifyContent="center">
        <Grid item xs={12} sm={4}>
          <Box p={2}>
            <TwitterTweetEmbed tweetId={'1393205689854668801'}/>
          </Box>
        </Grid>

        <Grid item xs={12} sm={4}>
          <Box p={2}>
            <iframe src="https://open.spotify.com/embed/artist/39Y7msOE4kJgTi8xvbYgRs" title="Spotify" width="300" height="380" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
          </Box>
        </Grid>

        <Grid item xs={12} sm={4}>
          <Box p={1}>
            <blockquote className="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/p/CQqidOOpFSM/?utm_source=ig_embed&amp;utm_campaign=loading" data-instgrm-version="13" style={{"background":"#FFF","border":"0","borderRadius":"3px","boxShadow":"0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15)","margin":"1px","maxWidth":"540px","minWidth":"326px","padding":"0","width":"calc(100% - 2px)"}}>
             <div style={{"padding":"16px"}}>
                <a href="https://www.instagram.com/p/CQqidOOpFSM/?utm_source=ig_embed&amp;utm_campaign=loading" style={{"background":"#FFFFFF","lineHeight":"0","padding":"0 0","textAlign":"center","textDecoration":"none","width":"100%"}} target="_blank" rel="noreferrer">
                ...
                <p style={{"color":"#c9c8cd","fontFamily":"Arial,sans-serif","fontSize":"14px","lineHeight":"17px","marginBottom":"0","marginTop":"8px","overflow":"hidden","padding":"8px 0 7px","textAlign":"center","textOverflow":"ellipsis","whiteSpace":"nowrap"}}>
                  <a href="https://www.instagram.com/p/CQqidOOpFSM/?utm_source=ig_embed&amp;utm_campaign=loading" style={{"color":"#c9c8cd","fontFamily":"Arial,sans-serif","fontSize":"14px","fontStyle":"normal","fontWeight":"normal","lineHeight":"17px","textDecoration":"none"}} target="_blank" rel="noreferrer">A post shared by IAN (@mrianlockwood)</a>
                </p>
             </div>
          </blockquote>
